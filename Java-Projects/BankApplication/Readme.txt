...
Scenario : A Back end developer and need to create an application to handle new customer bank account requests.

The Application should do the following:

	--> Read a .csv file of names, social security numbers, accounts type and intial deposit
	...
	--> Checking Account holders are assigned a Debut Card with 12 digit number and 4 digit PIN.
	...
	--> Explore access modifiers and when to use public, privare or protected
	--> Read Data from a file and store in an approproate data structure
